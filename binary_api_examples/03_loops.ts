...
module.addFunction(
  ...
  binaryen.i32,
  [binaryen.i32, binaryen.i32], // locals: var 1 (result), var 2 (i)
  module.block(null, [
    ...
    module.block("loop_out", [
      module.loop("loop",
        module.block(null, [
          ...
          module.br_if("loop_out",
            module.i32.gt_u(module.local.get(2, binaryen.i32), module.local.get(0, binaryen.i32))
          ),
          // result = result * i
          module.local.set(1,
            module.i32.mul(module.local.get(1, binaryen.i32), module.local.get(2, binaryen.i32))
          ),
          // i = i + 1
          module.local.set(2,
