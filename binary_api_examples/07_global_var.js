...
module.addFunction("increment", binaryen.createType([]), binaryen.i32, [], module.block(null, [
    module.global.set("counter", module.i32.add(module.global.get("counter", binaryen.i32), module.i32.const(1))),
