(module
 ...
 (type $16 (func (result (ref $Shape))))
 (type $17 (func (param (ref $Shape) i32 i32) (result (ref $Shape))))
 (type $18 (func (param (ref $Shape) i32) (result (ref $Object))))
 (type $19 (func (param (ref $Object) i32 anyref)))
 (type $20 (func (param (ref $Object) i32 anyref) (result anyref)))
 (type $21 (func (param (ref $Shape) i32) (result i32)))
 (type $22 (func (param (ref $Object) (ref $CallSite) i32) (result anyref)))
 ...
 (import "env" "print_i32" (func $print_i32 (type $13) (param i32)))
 (import "env" "print_f64" (func $print_f64 (type $14) (param f64)))
 (import "env" "print_string" (func $print_string (type $15) (param (ref $String))))
 ...
 (func $new_root_shape (type $16) (result (ref $Shape))
  (struct.new $Shape
   (ref.null none)
   (i32.const -1)
   (i32.const -1)
 ...
 (func $extend_shape (type $17) (param $parent (ref $Shape)) (param $key i32) (param $offset i32) (result (ref $Shape))
  (struct.new $Shape
   (local.get $parent)
   (local.get $key)
   (local.get $offset)
 ...
 (func $new_object (type $18) (param $shape (ref $Shape)) (param $size i32) (result (ref $Object))
  (struct.new $Object
   (local.get $shape)
 ...
 (func $set_storage (type $19) (param $obj (ref $Object)) (param $idx i32) (param $val anyref)
  (array.set $Storage
 ...
 (func $put_field (type $20) (param $obj (ref $Object)) (param $key i32) (param $val anyref) (result anyref)
 ...
 (func $lookup_in_shape (type $21) (param $shape (ref $Shape)) (param $key i32) (result i32)
 ...
 (func $get_field_slow (type $22) (param $obj (ref $Object)) (param $cache (ref $CallSite)) (param $key i32) (result anyref)
  (local $offset i32)
  (local $shape (ref $Shape))
  (local.set $shape
   (struct.get $Object $shape
 ...
 (func $get_field_cached (type $22) (param $obj (ref $Object)) (param $cache (ref $CallSite)) (param $key i32) (result anyref)
  (if
   (ref.eq
    (struct.get $Object $shape
     (local.get $obj)
