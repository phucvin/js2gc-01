(module
  ...
  (rec
    ...
    (type $Entry (struct
      (field $key i32) ;; Changed from stringref to i32
  ...
  (func $find_entry (param $obj (ref $Object)) (param $key i32) (result (ref null $Entry))
    ...
    (loop $search
      ...
      (if (i32.eq (struct.get $Entry $key (local.get $curr)) (local.get $key))
  ...
  (func $set_field (param $obj (ref $Object)) (param $key i32) (param $val anyref)
  ...
  (func $get_field (param $obj (ref $Object)) (param $key i32) (result anyref)
    (local $entry (ref null $Entry))
    (local.set $entry (call $find_entry (local.get $obj) (local.get $key)))
  ...
  (func $call_method (param $obj (ref $Object)) (param $method_name i32) (result anyref)
    (local $val anyref)
  ...
  (func $get_x (type $MethodSig) (param $self (ref $Object)) (result anyref)
    (call $get_field (local.get $self) (i32.const 1)) ;; x
  )
  ...
  (func $sum_x_y (type $MethodSig) (param $self (ref $Object)) (result anyref)
    ...
    (local.set $x (call $get_field (local.get $self) (i32.const 1))) ;; x
    (local.set $y (call $get_field (local.get $self) (i32.const 2))) ;; y
  ...
  (func $main (result i32)
    ...
    ;; Add field "x" (1) = 10
    (call $set_field (local.get $obj) (i32.const 1) (ref.i31 (i32.const 10)))

    ;; Add field "y" (2) = 20
    (call $set_field (local.get $obj) (i32.const 2) (ref.i31 (i32.const 20)))

    ;; Add method "get_x" (3)
    (call $set_field (local.get $obj) (i32.const 3)
      (struct.new $Method (ref.func $get_x))
    )

    ;; Add method "sum" (4)
    (call $set_field (local.get $obj) (i32.const 4)
      (struct.new $Method (ref.func $sum_x_y))
    )

    ;; Call "sum" (4) -> should be 30
    (local.set $res (call $call_method (local.get $obj) (i32.const 4)))
