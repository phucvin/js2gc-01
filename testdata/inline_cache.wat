(module
 ...
 (type $16 (func (param (ref $Object) (ref $Shape) (ref $CallSite) i32) (result anyref)))
 ...
 (func $get_field_resolve (type $16) (param $obj (ref $Object)) (param $shape (ref $Shape)) (param $cache (ref $CallSite)) (param $key i32) (result anyref)
  (local $offset i32)
