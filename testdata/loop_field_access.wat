(module
 ...
 (type $13 (func))
 (type $14 (func (param (ref $Shape) i32 anyref) (result (ref $Object))))
 ...
 (func $new_object (type $14) (param $shape (ref $Shape)) (param $size i32) (param $proto anyref) (result (ref $Object))
  (struct.new $Object
   (local.get $shape)
