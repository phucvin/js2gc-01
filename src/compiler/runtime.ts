...
export const RUNTIME_CLOSURE_SIGS = `
...
export const RUNTIME_GLOBALS_DECL = `
...
export function getRuntimeInit(nullData: string, objData: string): string {
    return `
  (func $runtime_init
...
export function getRuntimeHelpers(enableInlineCache: boolean): string {
    return `
